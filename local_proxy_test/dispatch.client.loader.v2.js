...
(function () {
    console.log("********** dispatch.client.loader.v2.js LOADED LOCALLY")
    ...
    function initialize (cfg) {
        ...
        script.async = true;
        script.src = "dispatch.client.driver.v2.js?cachebuster=" + buster;
        script.onload = function () {
            if (! script.readyState || /loaded|complete/.test(script.readyState)) {
                ...
                window.dispatch_content_frame.document.location.href = "DispatchHost.v2.html?cachebuster=" + buster + "&URL=" + encodeURIComponent(contentUrl) + "#" + pipeDomain;
            }
        };
