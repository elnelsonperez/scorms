...
var EXIT_TARGET = "https://cloud.scorm.com/EngineWebServices/Message.html";
...
var PASS_FAIL_SETS_COMPLETION_FOR_2004 = false;
...
(function () {
    ...
    TinCan.Utils = {
        ...
        parseURL: function (url, cfg) {
            ...
            if (isRelative) {
                result = { protocol: null, host: null, hostname: null, port: null, path: null, pathname: match[1], search: match[2], hash: match[3], params: {} };
                result.path = result.pathname;
            } else {
                result = { protocol: match[1], host: match[2], hostname: match[3], port: match[4], pathname: match[5], search: match[6], hash: match[7], params: {} };
    ...
    LRS.prototype = {
        ...
        _queryStatementsRequestCfg: function (cfg) {
            ...
            var params = {},
                ...
                i,
                prop,
                universal = { verb: true, registration: true, since: true, until: true, limit: true, ascending: true },
                compatibility = {
                    "0.9": { supported: { actor: true, instructor: true, target: true, object: true, context: true, authoritative: true, sparse: true } },
                    "1.0.0": { supported: { agent: true, activity: true, related_activities: true, related_agents: true, format: true, attachments: true } },
                };
        ...
        retrieveState: function (key, cfg) {
            ...
            requestCfg = { url: "activities/state", method: "GET", params: requestParams, ignore404: true, headers: requestHeaders };
            if (typeof cfg.callback !== "undefined") {
                callbackWrapper = function (err, xhr) {
                    var result = xhr;
                    if (err === null) {
        ...
        retrieveStateIds: function (cfg) {
            ...
            requestCfg = { url: "activities/state", method: "GET", params: requestParams, headers: requestHeaders, ignore404: true };
            if (typeof cfg.callback !== "undefined") {
                callbackWrapper = function (err, xhr) {
                    var result = xhr;
                    if (err !== null) {
        ...
        saveState: function (key, val, cfg) {
            ...
            requestCfg = { url: "activities/state", method: cfg.method, params: requestParams, data: val, headers: requestHeaders };
            if (typeof cfg.callback !== "undefined") {
                requestCfg.callback = cfg.callback;
            }
        ...
        dropState: function (key, cfg) {
            ...
            requestCfg = { url: "activities/state", method: "DELETE", params: requestParams, headers: requestHeaders };
            if (typeof cfg.callback !== "undefined") {
                requestCfg.callback = cfg.callback;
            }
            return this.sendRequest(requestCfg);
        ...
        retrieveActivity: function (activityId, cfg) {
            ...
            var requestCfg = {},
                ...
                requestHeaders;
            requestHeaders = cfg.requestHeaders || {};
            requestCfg = { url: "activities", method: "GET", params: { activityId: activityId }, ignore404: true, headers: requestHeaders };
            if (typeof cfg.callback !== "undefined") {
                callbackWrapper = function (err, xhr) {
                    var result = xhr;
                    if (err === null) {
        ...
        retrieveActivityProfile: function (key, cfg) {
            ...
            var requestCfg = {},
                ...
                self = this;
            requestHeaders = cfg.requestHeaders || {};
            requestCfg = { url: "activities/profile", method: "GET", params: { profileId: key, activityId: cfg.activity.id }, ignore404: true, headers: requestHeaders };
            if (typeof cfg.callback !== "undefined") {
                callbackWrapper = function (err, xhr) {
                    var result = xhr;
                    if (err === null) {
        ...
        retrieveActivityProfileIds: function (cfg) {
            ...
            cfg = cfg || {};
            requestHeaders = cfg.requestHeaders || {};
            requestCfg = { url: "activities/profile", method: "GET", params: { activityId: cfg.activity.id }, headers: requestHeaders, ignore404: true };
            if (typeof cfg.callback !== "undefined") {
                callbackWrapper = function (err, xhr) {
                    var result = xhr;
                    if (err !== null) {
        ...
        saveActivityProfile: function (key, val, cfg) {
            ...
            requestCfg = { url: "activities/profile", method: cfg.method, params: { profileId: key, activityId: cfg.activity.id }, data: val, headers: requestHeaders };
            if (typeof cfg.callback !== "undefined") {
                requestCfg.callback = cfg.callback;
            }
            if (typeof cfg.lastSHA1 !== "undefined" && cfg.lastSHA1 !== null) {
        ...
        dropActivityProfile: function (key, cfg) {
            ...
            requestCfg = { url: "activities/profile", method: "DELETE", params: requestParams, headers: requestHeaders };
            if (typeof cfg.callback !== "undefined") {
                requestCfg.callback = cfg.callback;
            }
            return this.sendRequest(requestCfg);
        ...
        retrieveAgentProfile: function (key, cfg) {
            ...
            var requestCfg = {},
                ...
                self = this;
            requestHeaders = cfg.requestHeaders || {};
            requestCfg = { method: "GET", params: { profileId: key }, ignore404: true, headers: requestHeaders };
            if (this.version === "0.9") {
        ...
        retrieveAgentProfileIds: function (cfg) {
            ...
            cfg = cfg || {};
            requestHeaders = cfg.requestHeaders || {};
            requestCfg = { method: "GET", params: requestParams, headers: requestHeaders, ignore404: true };
            if (this.version === "0.9") {
                requestCfg.url = "actors/profile";
                requestParams.actor = JSON.stringify(cfg.agent.asVersion(this.version));
            } else {
        ...
        saveAgentProfile: function (key, val, cfg) {
            ...
            requestCfg = { method: cfg.method, params: { profileId: key }, data: val, headers: requestHeaders };
            if (this.version === "0.9") {
                requestCfg.url = "actors/profile";
                requestCfg.params.actor = JSON.stringify(cfg.agent.asVersion(this.version));
            } else {
        ...
        dropAgentProfile: function (key, cfg) {
            ...
            requestCfg = { method: "DELETE", params: requestParams, headers: requestHeaders };
            if (this.version === "0.9") {
                requestCfg.url = "actors/profile";
                requestParams.actor = JSON.stringify(cfg.agent.asVersion(this.version));
            } else {
    ...
    Attachment.prototype = {
        ...
        asVersion: function (version) {
            ...
            if (version === "0.9" || version === "0.95") {
                ...
                result = { contentType: this.contentType, display: this.display, length: this.length, sha2: this.sha2, usageType: this.usageType };
...
(function () {
    ...
    TinCan.LRS.prototype._initByEnvironment = function (cfg) {
        ...
        isXD =
            ...
            locationPort !== (urlParts[3] !== null && typeof urlParts[3] !== "undefined" && urlParts[3] !== "" ? urlParts[3] : urlParts[1] === "http:" ? "80" : urlParts[1] === "https:" ? "443" : "");
        if (isXD) {
            if (env.hasCORS) {
...
(function (global) {
    ...
    function ISO2022JPDecoder(options) {
        var fatal = options.fatal;
        var states = { ASCII: 0, Roman: 1, Katakana: 2, LeadByte: 3, TrailByte: 4, EscapeStart: 5, Escape: 6 };
    ...
    function ShiftJISDecoder(options) {
        ...
        this.handler = function (stream, bite) {
            ...
            if (shiftjis_lead !== 0x00) {
                ...
                if (code_point === null && pointer !== null && inRange(pointer, 8836, 10528)) return 0xe000 + pointer - 8836;
                if (code_point === null && isASCIIByte(bite)) stream.prepend(bite);
                if (code_point === null) return decoderError(fatal);
                return code_point;
            }
    ...
    if (typeof module !== "undefined" && module.exports) {
        module.exports = { TextEncoder: global["TextEncoder"], TextDecoder: global["TextDecoder"], EncodingIndexes: global["encoding-indexes"] };
    }
})(this);
(function () {
    ...
    TinCan.LRS.prototype._initByEnvironment = function (cfg) {
        ...
        this._makeRequest = function (_fullUrl, headers, cfg) {
            ...
            fetchRequestCfg = { mode: "cors", cache: "no-cache", credentials: "include", keepalive: true, method: cfg.method, headers: { "Content-Type": headers["Content-Type"] }, body: cfg.data };
            try {
...
(function (root, factory) {
    ...
    URI.find_uri_expression = /\b((?:[a-z][\w-]+:(?:\/{1,3}|[a-z0-9%])|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()<>]+|\(([^\s()<>]+|(\([^\s()<>]+\)))*\))+(?:\(([^\s()<>]+|(\([^\s()<>]+\)))*\)|[^\s`!()\[\]{};:'".,<>?Â«Â»]))/gi;
...
(function () {
    "use strict";
    var THIS_LIBRARY = { VERSION: "<%= pkg.version %>", NAME: "<%= pkg.name %>", DESCRIPTION: "<%= pkg.description %>" },
        nativeRequest,
        xdrRequest,
        requestComplete,
        __delay,
        ...
        CATEGORY_ACTIVITY_CMI5 = new TinCan.Activity({ id: "https://w3id.org/xapi/cmi5/context/categories/cmi5" }),
        CATEGORY_ACTIVITY_MOVEON = new TinCan.Activity({ id: "https://w3id.org/xapi/cmi5/context/categories/moveon" }),
        OTHER_ACTIVITY_CMI5JS = new TinCan.Activity({
            ...
            definition: { name: { und: THIS_LIBRARY.NAME + " (" + THIS_LIBRARY.VERSION + ")" }, description: { en: THIS_LIBRARY.DESCRIPTION }, type: "http://id.tincanapi.com/activitytype/source" },
        }),
    ...
    Cmi5.prototype = {
            ...
            this._lrs.retrieveAgentProfile(AGENT_PROFILE_LEARNER_PREFS, {
                ...
                callback: function (err, result) {
                    ...
                    if (result !== null) {
                        ...
                        self._learnerPrefs = new TinCan.AgentProfile({ id: AGENT_PROFILE_LEARNER_PREFS, contentType: "application/json", contents: {} });
                    }
                    callback(null, result);
                },
            });
            ...
            if (callback) {
                cbWrapper = function (err, result) {
                    ...
                    self._learnerPrefs.etag = TinCan.Utils.getSHA1String(
                        typeof self._learnerPrefs.contents === "object" && TinCan.Utils.isApplicationJSON(self._learnerPrefs.contentType) ? JSON.stringify(self._learnerPrefs.contents) : self._learnerPrefs.contents
                    );
                    callback(null, result);
                };
            }
            result = this._lrs.saveAgentProfile(AGENT_PROFILE_LEARNER_PREFS, this._learnerPrefs.contents, { agent: this._actor, lastSHA1: this._learnerPrefs.etag, contentType: this._learnerPrefs.contentType, callback: cbWrapper });
            if (cbWrapper) {
                return;
            }
            if (result.err !== null) {
        ...
        setLRS: function (endpoint, auth) {
            ...
            if (this._lrs !== null) {
                ...
                this._lrs = new TinCan.LRS({ endpoint: endpoint, auth: auth, allowFail: false });
            }
        },
        getLRS: function () {
            return this._lrs;
        ...
        prepareStatement: function (verbId) {
            var stCfg = { actor: this._actor, verb: { id: verbId }, target: this._activity, context: this._prepareContext() },
            ...
            if (verbId !== VERB_COMPLETED_ID && progress !== null) {
                stCfg.result = { extensions: { "https://w3id.org/xapi/cmi5/result/extensions/progress": progress } };
            }
...
function TCAPI_Initialize() {
    ...
    try {
        tincan = new TinCan({ url: TCAPI_GetLaunchUrl(), recordStores: TC_RECORD_STORES, activity: { id: TC_COURSE_ID, definition: { name: TC_COURSE_NAME, description: TC_COURSE_DESC } } });
    } catch (ex) {
...
function TCAPI_SetBookmark(value, name) {
    ...
    tincan.sendStatement(
        { verb: TCAPI_VERB_EXPERIENCED, object: { id: tincan.activity.id + "/" + value, definition: { name: { "en-US": name !== undefined && name !== "" ? name : value } } }, context: { contextActivities: { parent: tincan.activity } } },
...
function TCAPI_RecordInteraction(strID, strResponse, blnCorrect, strCorrectResponse, strDescription, intWeighting, intLatency, strLearningObjectiveID, dtmTime, TCAPIInteractionType, strAlternateResponse, strAlternateCorrectResponse) {
    ...
    switch (TCAPIInteractionType) {
        case "true-false":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "true-false", name: { und: activityName } } };
            break;
        case "choice":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "choice", name: { und: activityName } } };
            break;
        case "fill-in":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "fill-in", name: { und: activityName } } };
            break;
        case "matching":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "matching", name: { und: activityName } } };
            break;
        case "performance":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "performance", name: { und: activityName } } };
            break;
        case "sequencing":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "sequencing", name: { und: activityName } } };
            break;
        case "likert":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "likert", name: { und: activityName } } };
            break;
        case "numeric":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "numeric", name: { und: activityName } } };
            break;
        case "other":
            actObj = { id: interactionActivityId, definition: { description: { "en-US": strDescription }, type: interactionActivityType, interactionType: "other", name: { und: activityName } } };
            break;
        default:
...
var CMI5_PENDING_STATUS = { completion: null, success: null, score: null },
    CMI5_COMMITTED_STATUS = { completion: null, success: null, score: null, launchModes: [] },
...
function CMI5_SaveState(key, value, contentType, includeRegistration) {
    ...
    var saveStateCfg = { agent: cmi5.getActor(), activity: cmi5.getActivity(), contentType: contentType },
        result,
        errCode,
        errMesg,
        errDiag;
...
function CMI5_RetrieveState(key, includeRegistration) {
    ...
    var retrieveStateCfg = { agent: cmi5.getActor(), activity: cmi5.getActivity() },
        result,
        value = "",
        errCode,
        errMesg,
...
function CMI5_CommitData() {
    ...
    var i,
        ...
        sourceActivity = new TinCan.Activity({
            ...
            definition: { name: { und: "ScormDriver (" + VERSION + ")" }, description: { en: "ScormDriver (" + VERSION + ")" }, type: "http://id.tincanapi.com/activitytype/source" },
        });
    CMI5_ClearErrorInfo();
...
function CMI5_SetScore(intScore, intMaxScore, intMinScore) {
    ...
    score = { raw: intScore, max: intMaxScore, min: intMinScore, scaled: RoundToPrecision(intScore / 100, 2) };
    try {
...
function CMI5_RecordInteraction(strID, strResponse, blnCorrect, strCorrectResponse, strDescription, intWeighting, intLatency, strLearningObjectiveID, dtmTime, interactionType, strAlternateResponse, strAlternateCorrectResponse) {
    ...
    if (strLearningObjectiveID !== "") {
        st.context.contextActivities.grouping = st.context.contextActivities.grouping || [];
        st.context.contextActivities.grouping.push(new TinCan.Activity({ id: strLearningObjectiveID }));
    }
    st.target = new TinCan.Activity({ id: strID, definition: { type: CMI5_INTERACTION_ACTIVITY_TYPE, interactionType: interactionType } });
...
function CMI5_RecordMatchingInteraction(strID, aryResponse, blnCorrect, aryCorrectResponse, strDescription, intWeighting, intLatency, strLearningObjectiveID, dtmTime) {
    ...
    for (i = 0; i < aryCorrectResponse.length; i += 1) {
        ...
        strCorrectResponse +=
            (aryCorrectResponse[i].Source.Long !== "" ? aryCorrectResponse[i].Source.Long : aryCorrectResponse[i].Source.Short) +
            "[.]" +
            (aryCorrectResponse[i].Target.Long !== "" ? aryCorrectResponse[i].Target.Long : aryCorrectResponse[i].Target.Short);
    }
